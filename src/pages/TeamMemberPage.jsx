...
const members = [
  ...
  },
  {
    ...
    description:
      "AI Product Developer, Team Project Coordinator, DevOps & Cloud",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Meet the talented developers behind ReBuild Ireland. Our dedicated team combines expertise in AI and software development to create an innovative platform that simplifies property renovation across Ireland."
        />
        <meta
          name="keywords"
          content="ReBuild Ireland team, project developers, AI platform developers, software development team, Ireland tech team, ReBuild Ireland creators, development team, innovative platform creators"
        />
      </Helmet>
      <div className="mx-auto py-3">
        <h1 className="text-customGreen font-semibold text-3xl py-3">
          ReBuild Ireland Team
        </h1>
